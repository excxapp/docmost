  ...
  return (
    <>
      <Box maw="500" mx="auto">
        ...
        <TagsInput
          mt="sm"
          description={t("Enter valid email addresses separated by comma or space [max: 50]")}
        ...
        <MultiGroupSelect
          mt="sm"
          description={t("Invited members will be granted access to spaces the groups can access")}
